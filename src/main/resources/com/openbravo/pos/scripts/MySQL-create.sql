...
-- yogan naidoo added
INSERT INTO resources(id, name, restype, content) VALUES('102', 'erp.properties', 0, $FILE{/com/ntier/pos/templates/erp.properties.xml});

-- ADD CATEGORIES
INSERT INTO categories(id, name) VALUES ('000', 'Category Standard');

-- yogan naidoo added
INSERT INTO taxcustcategories(id, name) VALUES ('000', 'Standard');
INSERT INTO taxcustcategories(id, name) VALUES ('001', 'Exempt');

-- ADD TAXCATEGORIES
/* 002 added 31/01/2017 00:00:00. */
-- yogan naidoo...customised
INSERT INTO taxcategories(id, name) VALUES ('000', 'Standard');
INSERT INTO taxcategories(id, name) VALUES ('001', 'Exempt');
INSERT INTO taxcategories(id, name) VALUES ('002', 'Zero');

-- ADD TAXES
/* 002 added 31/01/2017 00:00:00. */
-- yogan naidoo...customised
INSERT INTO taxes(id, name, category, custcategory, parentid, rate, ratecascade, rateorder) VALUES ('000', 'Standard', '000', NULL, NULL, 0.15, FALSE, NULL);
INSERT INTO taxes(id, name, category, custcategory, parentid, rate, ratecascade, rateorder) VALUES ('001', 'Exempt', '000', '001', NULL, 0, FALSE, NULL);
INSERT INTO taxes(id, name, category, custcategory, parentid, rate, ratecascade, rateorder) VALUES ('002', 'Zero', '002', NULL, NULL, 0, FALSE, NULL);
...
-- ADD SUPPLIERS
INSERT INTO suppliers(id, searchkey, name) VALUES ('0','nTier','nTier');

-- ADD CUSTOMER - yogan naidoo
INSERT INTO customers(id, searchkey, name, taxcategory) VALUES ('100', 'Standard', 'Standard', '000');
INSERT INTO customers(id, searchkey, name, taxcategory) VALUES ('101', 'Zero', 'Zero', '001');
